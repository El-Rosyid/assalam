            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative bg-white rounded-3xl shadow-2xl max-w-lg w-full mx-auto transform transition-all scale-100">
                    ...
                    <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-t-3xl p-8 text-center">
                        ...
                        <h2 class="text-3xl font-bold text-white">Berhasil!</h2>
                    </div>
                    
                    <!-- Success Body -->
                    <div class="p-10 text-center">
                        <h3 class="text-xl font-semibold text-gray-800 mb-4">Data Siswa Berhasil Diperbarui!</h3>
                        <p class="text-gray-600 text-lg leading-relaxed mb-8">
                            Perubahan data siswa telah berhasil disimpan ke dalam sistem. Semua informasi telah diperbarui dengan sukses.
                        </p>
                        ...
                        <div class="space-y-3">
                            <button 
                                ...
                                class="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-200 transform hover:scale-105 shadow-lg"
                            >
                                Tutup
                            </button>
                            <button 
                                onclick="window.location.href='/admin/data-siswas'"
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative bg-white rounded-3xl shadow-2xl max-w-lg w-full mx-auto transform transition-all scale-100">
                    ...
                    <div class="bg-gradient-to-r from-red-500 to-rose-600 rounded-t-3xl p-8 text-center">
                        ...
                        <h2 class="text-3xl font-bold text-white">Oops!</h2>
                    </div>
