...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('student_assessments', function (Blueprint $table) {
            // Add tahun_ajaran_id column after siswa_nis
            $table->bigInteger('tahun_ajaran_id')->unsigned()->nullable()->after('siswa_nis');
        ...
        DB::statement("
            ...
            INNER JOIN data_siswa ds ON sa.siswa_nis = ds.nis
